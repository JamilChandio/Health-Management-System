...
/**
 * Servlet Filter implementation class UpdatePerson
 */
@WebFilter(urlPatterns = { "/UpdatePatient", "/UpdateDoctor" })
public class UpdatePerson extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!validateGender(gender)) {
			handleError(response, "PLEASE ENTER PERSON GENDER IN CORRECT FORMAT: MALE OR FEMALE!");
			return;
		}
	...
	private static boolean validateGender(String gender) {
		...
		return lowercaseGender.equals("male") || lowercaseGender.equals("female");
	}
