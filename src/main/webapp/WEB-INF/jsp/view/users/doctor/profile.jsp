		...
		<div class="container-sm">
			<form action="UpdateDoctorProfile" method="post">
				...
				<div class="form-group">
					<label for="adminId">Doctor ID</label> <input type="text" disabled
						value="${sessionScope.person.getDoctorId() }" class="form-control"
						id="adminId">
				</div>
				...
				<div class="form-group">
					<label for="specialization">Specialization</label> <input required
						type="text" value="${sessionScope.person.getSpecialization() }"
				...
				<div class="form-group">
					...
					<textarea required class="form-control" name="description"
						id="description" rows="3"><c:out
							value="${sessionScope.person.getDoctorDesc()}"></c:out></textarea>
				</div>
